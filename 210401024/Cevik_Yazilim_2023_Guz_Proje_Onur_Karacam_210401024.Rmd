...
#### Q6'daki son tablomuzda da gördüğümüz üzere **Astoria** şubesinde **`r unique(zaman_araligi2$transaction_date)`** tarihinde **11:00:00 - 12:00:00** saat aralığında yapacağımız reklam kampanyasında **Columbian Medium Roast** ürününün yanına **Traditional Blend Chai** ürününü yerleştirerek;  **Traditional Blend Chai** ürününün satışını artırmak.

![](../210401024/OutdoorStand.jpg){width=75%}
